...
<body>
	<div class="header">
		<h1 class="title">
			<a href="../home/index" style="color: inherit; text-decoration: none">PDF
				To Word</a>
		</h1>
		<div class="dropdown">
			...
			<div id="myDropdown" class="dropdown-content">
				<a href="#history">History</a> <a href="../account/LogoutServlet">Log
					out</a>
			</div>
		</div>
	</div>
	<div class="manage-container">
		<div class="manage-container__header">
			...
			<div class="manage-container__action">
				...
				<button class="download-btn table-btn"
					onclick="showConfirmDownloadAll()">
		...
		<div class="manage-container__table">
			<table class="styled-table">
				<thead class="manage-container__table-header">
					<tr>
						<th><input id="select-all" type="checkbox" class="select"
							onclick="slectedAll()" /></th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="table-td-action">
							...
							<button class="download-btn table-btn"
								onclick="showConfirmDownload('<%= File.getId() %>')">
								<i class="fa-solid fa-file-arrow-down table-btn-icon"></i>
							</button>
						</td>
					</tr>
	...
	<div class="popup-delete popup">
		<form action="../fileStorage/DeleteFile" method="POST"
			class="popup__form delete-form">
			<input type="hidden" id="deleteId" name="deleteId" value="" />
			<p>Are you sure to delete ?</p>
			<div class="popup__action">
				<button type="submit" class="btn success-btn load-target"
					name="delete">Confirm</button>
				<button type="reset" class="btn success-btn load-target"
					onclick="unshowConfirmDelete()">Cancel</button>
			</div>
		</form>
	</div>

	<div class="popup-download popup">
		<form action="../fileStorage/DownloadFile" method="POST"
			class="popup__form download-form">
	...
	<div class="popup-delete popup delete-all">
		<form action="../fileStorage/DeleteAllFiles" method="POST"
			class="popup__form delete-form">
			<input type="hidden" id="deleteIdAll" name="deleteIdAll" value="" />
			<p>Are you sure to delete ?</p>
			<div class="popup__action">
				<button type="submit" class="btn success-btn load-target"
					name="deleteAll">Confirm</button>
				<button type="reset" class="btn success-btn load-target"
					onclick="unshowConfirmDeleteAll()">Cancel</button>
			</div>
		</form>
	</div>

	<div class="popup-download popup download-all">
		<form action="../fileStorage/DownloadAllFiles" method="POST"
			class="popup__form download-form">
